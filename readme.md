<p align="center">
    ...
    <h2 align="center">Rosé Pine for NixOS TTY</h2>
</p>
...
Can be installed with or without flakes
...
1. Modify `template.nix` using Rosé Pine variables, then build variants:

<!-- #rose-pine-build -->

```sh
npx @rose-pine/build@0.9.1 -t template.nix -o ./variants/ -f hex-ns
```
...
2. *(Optional)* Update `default.nix` if needed. This file imports the variants, and exposes them through a config
